...
st.image("Bild2.png")
st.header(":heavy_exclamation_mark: Bitte beachten :heavy_exclamation_mark:")
...
def main():
    uploaded_file = st.file_uploader("Bitte lade Sensordaten hoch. Diese können ein .JSON-Format oder auch ein .zip-Format haben, das CSVs enthält.", accept_multiple_files=False)
    if st.button("Klassifizieren!"):
        ...
        layout = go.Layout(
            ...
            },barmode='group', xaxis={'title': 'Stunde des Tages'}, yaxis={'title': 'Minuten'}, plot_bgcolor='#282C34', paper_bgcolor='#282C34', width= 1000, height= 400)
